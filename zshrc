...
alias s='zsh ~/wifi.zsh'
# alias s='~/scripts/./s.sh'
alias zshrc='vi ~/.zshrc'
alias jn='jupyter notebook'
alias al='asciiquarium | lolcat'
alias battery='acpi'
alias cuda='python -c "import torch; print(torch.cuda.is_available())"'
alias p='ping 1.1.1.1 -c 5'
...
source /home/aditya/github/zsh-syntax-highlighting/zsh-syntax-highlighting.zsh
